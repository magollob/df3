...
export default function SalesPage() {
  const testimonials1 = [
    "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/DEPOIMENTO-C1-5-576x1024-vLP6luAWjuTJN2kYc2e53Z1mLjtf73.webp",
    "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/DEPOIMENTO-C1-3-576x1024-eRjpVmV9bcJNIkU3TR3tPj0DSeT8Ee.webp",
    "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/DEPOIMENTO-C1-4-576x1024-G8FDi1943mVkf2Wa67zDYDCjqZ5nL6.webp",
  ]

  const testimonials2 = [
    "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/DEPOIMENTO-C1-6-576x1024-7T9g2GQ6ISKwyqmlsDJjopYiZ5Hp0J.webp",
    "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/DEPOIMENTO-C1-1-576x1024-AhiP11Rpt9s57ozIkIV4OyMni86R1q.webp",
  ]
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-br from-pink-400 to-pink-600 text-white p-6 text-center">
        ...
        <p className="text-lg text-white">
          Aprenda do zero a fazer doces caramelizados, e vários outros doces deliciosos gastando pouco e sem precisar de experiência.
        </p>
      </div>
      ...
      <footer className="p-6 text-center text-white" style={{ backgroundColor: "#3e2011" }}>
        <div className="max-w-md mx-auto">
          ...
          <div className="flex justify-center items-center space-x-4 mb-4">
            <img
              src="/images/design-mode/site%20seguro1.png"
              alt="Site Seguro SSL Certificado"
              className="h-12"
            />
            <img
              src="/images/design-mode/site%20blindado1.png"
              alt="Site Blindado"
              className="h-12"
            />
          </div>
